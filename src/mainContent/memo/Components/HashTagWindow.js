...
const HashTagWindow = ({allHashDatas, setAllHashDatas}) => {
            ...
            <HashTag>
                ...
                <div style={{width:'100%',height:'25px' }}>
                    <input 
                        ...
                        value={keyword}
                        style={{textAlign:'center', float: 'left', position:'relative', width: '90%', height:'100%'}}
                        type="text" placeholder='해시태그 입력'></input>
                    <SearchIcon style={{textAlign:'center', float: 'right',width: '10%', height: '100%'} }/>
                </div>
                {/* 해시 리스트 */}
                <div style={{overflowY: 'auto',width: '100%', height:'210px'}}>
                    {
                        console.log("=============="),
                ...
                </div>
                {
                    ...
                    <div onClick={handleToCreateHash}
                        ...
                        <AddIcon style={{float:'left' , width: '15%', height:'25px'}}/>
                        '
