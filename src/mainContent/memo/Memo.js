...
export default function(memo) {
  ...
  //   await axios
  //     .post(`http://localhsot:8080/doki/talk/memoRoom/${i}`)
  //     .then((Response) => {
  ...
  //     try{
  //     //소켓 열기
  //     var socket = new SockJS('http://localhsot:8080/doki/websocket');
...
//name : e.target.name, value : e.target.value, handling: memo.handling
  ...
  //       await axios({
  //         method: "post",
  //         url: `http://localhsot:8080/doki/talk/memo`,
  //         params: {
  ...
  //         await axios({
  //           method: "post",
  //           url: `http://localhsot:8080/doki/talk/memoOut`,
  //           params: {
  //             handling: memo.handling,
  //             roomId: 0,
  //             userNo: allinfo.no,
  ...
  const deleteEvent = () => {
    ...
    // api 통신 (visible => "0")
    axios
    .post("http://localhsot:8080/doki/memo/updateMemo", obj)
    .then((Response) => {
 ...
 //메모 수정 확인 버튼 클릭 시
  const addEvent = () => {
      ...
      axios
        .post("http://localhsot:8080/doki/memo/updateMemo", memo)
        .then((Response) => {
  ...
  useEffect(async() => {
    ...
    axios
      .all([
          ...
          await axios
            .get('http://localhsot:8080/doki/memo/getHashListByMemo/' + memo.no), 
          // 회사 전체 직원의 리스트 검색
          await axios
          .get('http://localhsot:8080/doki/hash/getAllHashList') 
      ])
      .then(
