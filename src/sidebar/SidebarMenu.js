...
export default function SidebarMenu() {
  ...
  const closeInviteModal = async () => {
    ...
    await axios
      ...
      .then((Response) => {
        ...
        setDeptUserDatas((deptUserDatas) => (deptUserDatas = Response.data));
        console.log("=============================== ");
  ...
  const closeGroupPermissionModal = async () => {
    ...
    await axios
      .put("http://localhost:8080/doki/user/updatePermission", [
        ...deptUserDatas,
      ])
      .then((Response) => {
    ...
    await axios
      ...
      .then(
        axios.spread((res1, res2) => {
          ...
          setDeptUserDatas((deptUserDatas) => (deptUserDatas = res1.data));

          console.log("====== get AllUserList 요청! ======");
          setAllUserDatas((allUserDatas) => (allUserDatas = res2.data));
        })
      )
      .catch((Error) => {
        console.log(Error);
