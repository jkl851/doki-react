...
export default function Sidebar({ division, setDivision, allinfo, setAllinfo, hashKeyword, setHashKeyword, deptAuth, setDeptAuth, allUserDatas, setAllUserDatas}) {
  ...
  return (
    <div className="sidebar" style={{ backgroundColor: "#f2f3f5" }}>
      ...
      <SidebarMenu division={division} hashKeyword={hashKeyword} setHashKeyword={setHashKeyword} allinfo={allinfo} setAllinfo={setAllinfo} deptAuth={deptAuth} setDeptAuth={setDeptAuth} 
                  allUserDatas={allUserDatas} setAllUserDatas={setAllUserDatas}/>
    </div>
  );
}
