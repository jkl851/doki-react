...
export default function MemoAlarmModal({memoMessages}) {
    ...
    return (
        <Fragment>                   
            ...
            <a id="mypopover2" ref={target} onClick={memoAlarmInfo} href="#about"><IoIosNotifications /></a>
            ...
            <Overlay
              ...
              placement="bottom"
              rootClose={true}
              onHide={() => {setMemoAlarmModal({isOpen: false})}}
            >
                <Popover
                ...
                >
                    <PopoverHeader >새로운 알림 - 메모</PopoverHeader> 
                        <PopoverBody className={alarmModalStyles.popoverbody}>    
                            {memoMessages.map(memoMessage => <MemoMessage key={memoMessage.no}
